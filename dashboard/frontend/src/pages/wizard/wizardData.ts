...
export const STORAGE_KEY = 'opentraitor_setup_wizard'
...
export const INITIAL_STATE: WizardState = {
  ...
  redditClientId: '',
  redditClientSecret: '',
  redditUserAgent: 'opentraitor/1.0',
  infraSecrets: {},
}
...
export function generateEnvContent(state: WizardState): string {
  ...
  lines.push('# ===========================================', '# OpenTraitor Environment Configuration',
...
export function generateRootEnvContent(state: WizardState, configEnv: string): string {
  ...
  return [
    ...
    `LANGFUSE_ADMIN_PASSWORD=${p('LANGFUSE_ADMIN_PASSWORD')}`, 'LANGFUSE_ADMIN_EMAIL=admin@opentraitor.local',
